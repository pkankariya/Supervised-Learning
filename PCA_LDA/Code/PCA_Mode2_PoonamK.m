...
% Mode 2 - all images of fisrt 25 40 subjects are used for training
train_data_mode2 = [sub1_data, sub2_data, sub3_data, sub4_data, sub5_data, sub6_data, sub7_data, sub8_data, sub9_data, sub10_data, sub11_data, sub12_data, sub13_data, sub14_data, sub15_data, sub16_data, sub17_data, sub18_data, sub19_data, sub20_data, sub21_data, sub22_data, sub23_data, sub24_data, sub25_data];

% Mode 1 - all images of remaining 15 subjects are used for testing
test_data_mode2 = [sub26_data, sub27_data, sub28_data, sub29_data, sub30_data, sub31_data, sub32_data, sub33_data, sub34_data, sub35_data, sub36_data, sub37_data, sub38_data, sub39_data, sub40_data];

%% Size of data
[r,c] = size(train_data_mode2);

%% Mean of training data
m_train_mode2 = mean(transpose(train_data_mode2));
mean_train_mode2 = transpose(m_train_mode2);

%% Subtratcing mean from each image (centering data)
train_data_mode2 = double(train_data_mode2);
d_train_mode2 = train_data_mode2 - repmat(mean_train_mode2,1,c);

%% Covaraince matrix computation for training set
co_train_mode1 = d_train_mode2 * transpose(d_train_mode2);

%% Computation of eigen values and eigen vectors of covariance matrix
[eigvector_mode2,eigvl_mode2] = eig(co_train_mode1);

%% Sorting eigen vector using the eigen values computed
eigenvalue_mode2 = diag(eigvl_mode2);
[junk,index] = sort(eigenvalue_mode2,'descend');
eigvalue_mode2 = eigenvalue_mode2(index);
eigenvector_mode2 = eigvector_mode2(:,index);

%% Computing number of eigen values greater than zero - setting threshold
count_mode2 = 0;
for i = 1:size(eigenvalue_mode2,1)
    if(eigenvalue_mode2(i)>0)
...
vec_mode2 = eigenvector_mode2(:,1:count_mode2);

%% Computing feature matrix in new feature subspace
train_project_mode2 = vec_mode2'*d_train_mode2;

%% Subtracting mean from test data
test_data_mode2 = double(test_data_mode2);
d_test_mode2 = test_data_mode2 - mean_train_mode2;

%% Projecting test data in new feature space
test_project_mode2 = vec_mode2'*d_test_mode2;

%% Partition test data projected as training and testing to evaluate performance
% Accessing first 5 images as training set of 15 test subjects from the projected data set on the new subspace
train_sub1_mode2 = test_project_mode2(:,1:5);
train_sub2_mode2 = test_project_mode2(:,11:15);
train_sub3_mode2 = test_project_mode2(:,21:25);
train_sub4_mode2 = test_project_mode2(:,31:35);
train_sub5_mode2 = test_project_mode2(:,41:45);
train_sub6_mode2 = test_project_mode2(:,51:55);
train_sub7_mode2 = test_project_mode2(:,61:65);
train_sub8_mode2 = test_project_mode2(:,71:75);
train_sub9_mode2 = test_project_mode2(:,81:85);
train_sub10_mode2 = test_project_mode2(:,91:95);
train_sub11_mode2 = test_project_mode2(:,101:105);
train_sub12_mode2 = test_project_mode2(:,111:115);
train_sub13_mode2 = test_project_mode2(:,121:125);
train_sub14_mode2 = test_project_mode2(:,131:135);
train_sub15_mode2 = test_project_mode2(:,141:145);

% Appending all training data together from the projected test data set
train_mode2_projectedtest = [train_sub1_mode2, train_sub2_mode2, train_sub3_mode2, train_sub4_mode2, train_sub5_mode2, train_sub6_mode2, train_sub7_mode2, train_sub8_mode2, train_sub9_mode2, train_sub10_mode2, train_sub11_mode2, train_sub12_mode2, train_sub13_mode2, train_sub14_mode2, train_sub15_mode2];

% Accessing next 5 images as test set of 15 test subjects from the projected data set on the new subspacetest_sub1_mode2 = test_project_mode2(:,6:10);
test_sub2_mode2 = test_project_mode2(:,16:20);
test_sub3_mode2 = test_project_mode2(:,26:30);
test_sub4_mode2 = test_project_mode2(:,36:40);
test_sub5_mode2 = test_project_mode2(:,46:50);
test_sub6_mode2 = test_project_mode2(:,56:60);
test_sub7_mode2 = test_project_mode2(:,66:70);
test_sub8_mode2 = test_project_mode2(:,76:80);
test_sub9_mode2 = test_project_mode2(:,86:90);
test_sub10_mode2 = test_project_mode2(:,96:100);
test_sub11_mode2 = test_project_mode2(:,106:110);
test_sub12_mode2 = test_project_mode2(:,116:120);
test_sub13_mode2 = test_project_mode2(:,126:130);
test_sub14_mode2 = test_project_mode2(:,136:140);
test_sub15_mode2 = test_project_mode2(:,146:150);

% Appending all test data together from the projected test data set
test_mode2_projectedtest = [test_sub2_mode2, test_sub2_mode2, test_sub3_mode2, test_sub4_mode2, test_sub5_mode2, test_sub6_mode2, test_sub7_mode2, test_sub8_mode2, test_sub9_mode2, test_sub10_mode2, test_sub11_mode2, test_sub12_mode2, test_sub13_mode2, test_sub14_mode2, test_sub15_mode2];

%% Computing scores using distance between the matrices
distance_mode2 = pdist2(test_mode2_projectedtest',train_mode2_projectedtest');

%% Normalize the eculidean distance 
norm_dist_mode2 = normalize(distance_mode2);

%% Assigning genuine and imposter scores to the distance matrix
r_mode2 = 1;
c_mode2 = 1;
score_mode2 = ones(75,75);
for i_mode2 = 1:(size(score_mode2,1)/5)
    score_mode2(r_mode2:r_mode2+4, c_mode2:c_mode2+4) = 0;
    r_mode2 = r_mode2+5;
    c_mode2 = c_mode2+5;
end

%% Computing ezroc
[roc, EER, area, EERthr, ALLthr, d, gen, imp] = ezroc3(distance_mode2,score_mode2,2,'ROC_mode2',1)
GAR_mode2 = transpose(roc(1,:));
FAR_mode2 = transpose(roc(2,:));